       ...
       #   "leading_dpho_pt                     := ? leading_dpho.pt() != 0 ? leading_dpho.pt() : -99",
        #  "leading_dpho_eta                    := ? leading_dpho.eta() != 0 ? leading_dpho.eta() : -99",
         ...
         # "leading_dpho_E                      := ? leading_dpho.E() != 0 ? leading_dpho.E() : -99",
          ...
          "Leading_Electron_pt                     := ? Leading_Electron.pt() != 0 ? Leading_Electron.pt() : -99 ",  
          "Leading_Electron_eta                    := ? Leading_Electron.eta() != 0 ? Leading_Electron.eta() : -99 ",
          "Leading_Electron_phi                    := ? Leading_Electron.phi() != 0 ? Leading_Electron.phi() : -99 ",
          "Leading_Electron_E                      := ? Leading_Electron.E() != 0 ? Leading_Electron.E() : -99 ",
          "subLeading_Electron_pt                  := ? Subleading_Electron.pt() != 0 ? SubLeading_Electron.pt() : -99 ",
          "subLeading_Electron_eta                 := ? Subleading_Electron.eta() != 0 ? SubLeading_Electron.eta() : -99 ",
          "subLeading_Electron_phi                 := ? Subleading_Electron.phi() != 0 ? SubLeading_Electron.phi() : -99 ",
          "subLeading_Electron_E                   := ? Subleading_Electron.E() != 0 ? SubLeading_Electron.E() : -99 ",
