...
#                    phosystlabels.append("MCSmear%s%s%s01sigma" % (r9,region,direction))
    ...
    import flashgg.Systematics.HHWWggCustomize
    hhwwggc = flashgg.Systematics.HHWWggCustomize.HHWWggCustomize(process, customize, customize.metaConditions)
    minimalNonSignalVariables += hhwwggc.variablesToDump()
...
process.source = cms.Source ("PoolSource",
                             fileNames = cms.untracked.vstring(
                                ...
                                "/store/user/spigazzi/flashgg/Era2017_RR-31Mar2018_v2/legacyRun2FullV1/DoubleEG/Era2017_RR-31Mar2018_v2-legacyRun2FullV1-v0-Run2017E-31Mar2018-v1/190606_095510/0001/myMicroAODOutputFile_1796.root"
                             ))
