...
fggDirec="/afs/cern.ch/user/r/rasharma/work/doubleHiggs/CMSSW_10_5_0/src/flashgg/" # flashgg directory
ntupleDirec="/afs/cern.ch/user/r/rasharma/work/doubleHiggs/CMSSW_10_5_0/src/flashgg/" # condor output directory
...
runSignal="true" # get dataset(s) from signal json file
