...
mkdir -p /eos/user/r/rasharma/post_doc_ihep/double-higgs/ntuples/Event_Dumper/$output_direc;
...
do
   ...
   mv $output_direc/*.root /eos/user/r/rasharma/post_doc_ihep/double-higgs/ntuples/Event_Dumper/$output_direc/
#    rm $output_direc/*.err
#    rm $output_direc/*.out
