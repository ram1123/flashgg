...
namespace flashgg {
  ...
  //---constructors
  // HHWWggFullyHadTagProducer::HHWWggFullyHadTagProducer( ):
  // photonToken_(),
  // diphotonToken_()
  // genParticleToken_(),
  // electronToken_(),
...
//-----------------------------------------------------------------------------------------------------------
      ...
      // cout << "in HHWWggFullyHadTagProducer.cc: Right before diphoton loop" << endl;
          ...
          */
          ...
          // Don't have semileptonic selections. Only results in further analysis if doHHWWggTagCutFlowAnalysis_ == True
            ...
            if(doHHWWggTagCutFlowAnalysis_){
              ...
              HHWWggTag tag_obj(dipho, theMET, allJets, tagJets, Cut_Variables);
