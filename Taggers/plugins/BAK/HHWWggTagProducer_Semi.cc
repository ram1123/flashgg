        ...
        for( unsigned int diphoIndex = 0; diphoIndex < 1; diphoIndex++ ) { // only look at highest pt dipho
          ...
          */
          ...
          if (n_good_leptons == 2) {
            ...
            HHWWggTag tag_obj(dipho, tag_electron, tag_muon,theMET,Cut_Variables);
            ...
            if (n_good_electrons == 2){
              ...
              // if (n_good_jets == 2){
                HHWWggTag tag_obj(dipho, tag_electron1, tag_electron2,theMET,Cut_Variables); // electron, MET, jet1, jet2 
            ...
            if (n_good_muons == 2){
              ...
              // if (n_good_jets == 2){
                ...
                HHWWggTag tag_obj(dipho, tag_muon1, tag_muon2,theMET,Cut_Variables); // electron, MET, jet1, jet2 
                // if (loopOverJets == 1) tag_obj.setSystLabel( inputDiPhotonSuffixes_[diphoton_idx] );
                // else tag_obj.setSystLabel( inputJetsSuffixes_[jet_col_idx]);
