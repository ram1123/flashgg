...
from flashgg.Taggers.flashggHHWWggCandidate_cfi import FlashggHHWWggCandidate
...
process = cms.Process("FLASHggHHWWggTest") # Can't use HHWWgg for name because '_' is a non-alphanumeric character

###---HHWWgg candidates production
process.FlashggHHWWggCandidate = FlashggHHWWggCandidate.clone()
...
###--- get the variables
import flashgg.Taggers.HHWWggTagVariables as var
...
process.HHWWggCandidateDumper = HHWWggCandidateDumper.clone()
process.HHWWggCandidateDumper.dumpTrees = True
...
process.path = cms.Path(process.dataRequirements*process.FlashggHHWWggCandidate*process.HHWWggCandidateDumper)
