...
cut=cms.string(
        "mass > 95" # Do we want to change this? Won't this cut most of Mass40-80 sample? 
        " && leadingPhoton.pt > 18 && subLeadingPhoton.pt > 18" # seems fine with 20-inf pt. 
...
for i in range(num_rec_hits):
        ...
        variables.append("rawId_" + str(i) + " := rawIds[" + str(i) + "] ")
